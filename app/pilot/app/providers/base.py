...
class MCPProvider(Protocol):
    ...
    async def update_cart(self, items: list[dict], address_id: str | None = None) -> dict: ...
    async def clear_cart(self) -> None: ...
    async def checkout(self, address_id: str, delivery_slot: str | None = None, estimated_total: float = 0.0) -> dict: ...
