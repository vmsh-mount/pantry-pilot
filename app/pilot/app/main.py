...
from app.api import auth, onboard, webhooks, settings_router, basket, orders, runs, routines, products, quick, nutrition, dashboard, pantry, assistant
...
app.include_router(routines.router,        prefix="/v1")
app.include_router(products.router,        prefix="/v1")
app.include_router(quick.router,           prefix="/v1")
